...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_1_mustache__ = __webpack_require__(20);
...
var Chat = function () {
    function Chat(messageInput, sendButton, messageTpl, recordTpl, messageRecord, messageSession) {
        ...
        this.messageTplData_ = __WEBPACK_IMPORTED_MODULE_0_jquery___default()(messageTpl).text();
        this.recordTplData_ = __WEBPACK_IMPORTED_MODULE_0_jquery___default()(recordTpl).text();
        console.log(__WEBPACK_IMPORTED_MODULE_0_jquery___default()(messageTpl));
        console.log(__WEBPACK_IMPORTED_MODULE_0_jquery___default()(recordTpl));
        ...
        for (var i = 0; i < 20; ++i) {
            __WEBPACK_IMPORTED_MODULE_0_jquery___default()(this.messageRecord_).append(__WEBPACK_IMPORTED_MODULE_1_mustache___default.a.render(this.getRecordTemplate(), recordJson));
            if (i % 2 == 0) {
                __WEBPACK_IMPORTED_MODULE_0_jquery___default()(this.messageSession_).append(__WEBPACK_IMPORTED_MODULE_1_mustache___default.a.render(this.getMessageTemplate(), messageJsonbyo));
            } else {
                __WEBPACK_IMPORTED_MODULE_0_jquery___default()(this.messageSession_).append(__WEBPACK_IMPORTED_MODULE_1_mustache___default.a.render(this.getMessageTemplate(), messageJsonbym));
            }
        }
        console.log(__WEBPACK_IMPORTED_MODULE_1_mustache___default.a.render(this.recordTplData_, recordJson));
    ...
    _createClass(Chat, [{
        ...
        value: function sendMessage(event) {
            ...
            var data = __WEBPACK_IMPORTED_MODULE_0_jquery___default()(that.messageInput_).val();
...
__WEBPACK_IMPORTED_MODULE_0_jquery___default()(document).ready(function () {
    ...
    var chat = new Chat('#messageInput', '#sendButton', '#messageTpl', '#recordTpl', '#messageRecord', '#messageSession');
});
