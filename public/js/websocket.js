...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_2_moment__ = __webpack_require__(31);
...
var Chat = function () {
    ...
    _createClass(Chat, [{
        ...
        value: function initRecordPanel() {
            ...
            var messageRecord = this.messageRecord_;
            ...
            http.onreadystatechange = function () {
                if (http.readyState === 4 && http.status === 200) {
                    ...
                    if (data.success) {
                        ...
                        __WEBPACK_IMPORTED_MODULE_0_jquery___default()(messageRecord).append(__WEBPACK_IMPORTED_MODULE_1_mustache___default.a.render(getRecordTemplate(), { records: records }));
        ...
        value: function displayMessages(sessionId, userId, that) {
            var messages = that.sessions_.get(sessionId);
            var renderMsg = new Array();
            for (var index in messages) {
                ...
                renderMsg[index] = obj;
                __WEBPACK_IMPORTED_MODULE_0_jquery___default()(that.messageSession_).html(__WEBPACK_IMPORTED_MODULE_1_mustache___default.a.render(that.getMessageTemplate(), { messages: renderMsg }));
            }
        }
    }, {
